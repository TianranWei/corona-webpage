...
function LinkRadialDiagonal(_ref2) {
  ...
  return _react.default.createElement("path", _extends({
    ref: innerRef,
    className: (0, _classnames.default)('vx-link vx-link-radial-diagonal', className),
    d: pathGen(data) || ''
  }, restProps));
}

LinkRadialDiagonal.propTypes = {
  angle: _propTypes.default.func.isRequired,
  radius: _propTypes.default.func.isRequired
};